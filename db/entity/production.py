...
association_table_4 = db.Table('stopped_resource_pack_x_production', db.Model.metadata,
                               db.Column('stopped_resource_pack_id', db.Integer, db.ForeignKey('resource_pack.id')),
                               db.Column('production_id', db.Integer, db.ForeignKey('production.id')),
                               )
...
class ProductionEntity(db.Model):
    ...
    to_resources_successful = db.relationship('ResourcePackEntity', secondary=association_table_3)
    to_resources_interrupted = db.relationship('ResourcePackEntity', secondary=association_table_4)
